            ...
            <div key={share.id} className="bg-dark-surface border border-dark-border rounded-xl p-6 shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className="px-2.5 py-0.5 rounded-full text-xs font-semibold bg-dark-bg text-gray-300 border border-dark-border">
                    {share.formatLabel}
                  </span>
                </div>
                <p className="text-sm text-gray-400 mb-4">
                  Shared with <span className="text-primary-400 font-medium">{share.receiver_name}</span> on {new Date(share.created_at).toLocaleDateString()}
                </p>
                
                <div className="flex flex-wrap gap-4">
                  {/* Views */}
                  <div className="flex items-center gap-2 text-sm min-w[100px] bg-dark-bg border border-dark-border px-3 py-2 rounded-lg">
              ...
              <div className="flex flex-row md:flex-col gap-3 min-w-[140px]">
                <button 
                  ...
                  className="flex-1 py-2 px-4 rounded-lg text-sm font-medium border border-dark-border bg-dark-bg hover:bg-dark-border text-white transition-colors flex justify-center items-center gap-2 shadow-sm"
                >
                   Copy Link
                </button>
                {share.status === 'Active' ? (
